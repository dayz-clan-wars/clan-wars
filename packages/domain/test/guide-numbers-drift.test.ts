...
const EXPECTED: Record<string, string> = {
  ...
  "Same clan raiding the same victim counts once per": hours(R.RAID_DEDUP_MS),
  ...
  "Base move: confirm window": hours(R.REBIND_CONFIRM_MS),
  "Base move: cooldown between moves": days(R.REBIND_COOLDOWN_MS),
