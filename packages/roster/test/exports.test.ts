 ...
 */
export const ROSTER_EXPORTS = ["DECLARE_SOLO_REASONS", "ISSUE_OUTCOME_KINDS", "VAULT_NAME_MAX", "VAULT_NOTE_MAX", "acceptInvite", "addLock", "alphas", "attention", "baseFor", "cancelLink", "castVote", "claimCeremony", "claimContext", "claimSuccession", "clanBoard", "clanByTag", "clanFor", "confirmLock", "confirmRebind", "decideRequest", "declareSolo", "declineInvite", "deleteLock", "deletePin", "demote", "directory", "disband", "dropPin", "editLock", "grantGuestPass", "invite", "kick", "leave", "linkStatus", "mapState", "myInvites", "myRequests", "openVote", "playerBoards", "playerProfile", "promote", "releaseSolo", "rename", "requestJoin", "revealLock", "revokeGuestPass", "revokeInvite", "rotateLocks", "scoreboard", "searchGamertags", "seasons", "setRecruitingPost", "startLink", "transfer", "unlink", "vaultFor", "viewerFor", "warLog", "withdrawRequest"] as const;
