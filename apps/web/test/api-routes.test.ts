 ...
 * /link, /kit and /awards/<id> status polls are the only GETs.
 */
...
const GET_ALLOWED = [`${sep}api${sep}auth${sep}`, `${sep}api${sep}link${sep}status${sep}`, `${sep}api${sep}kit${sep}status${sep}`, `${sep}api${sep}awards${sep}[id]${sep}status${sep}`, `${sep}api${sep}link${sep}search${sep}`, `${sep}api${sep}players${sep}suggest${sep}`, `${sep}api${sep}map${sep}state${sep}`, `${sep}api${sep}og${sep}`];
