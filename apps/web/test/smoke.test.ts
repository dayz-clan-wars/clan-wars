...
describe("the web app reads nothing", () => {
  ...
  it("⚠️ @factions/roster exports exactly the allowlist the site is permitted", async () => {
    ...
    expect(Object.keys(roster).sort()).toEqual(["BOARD_KINDS", "BOARD_PAGE_SIZE", "DECLARE_SOLO_REASONS", "FEED_PAGE_SIZE", "ISSUE_OUTCOME_KINDS", "REPORT_REASONS", "SUGGEST_SCOPES", "VAULT_NAME_MAX", "VAULT_NOTE_MAX", "acceptInvite", "achievementsFor", "addLock", "alphas", "attention", "baseDamageWindow", "baseFor", "boardPage", "cancelLink", "castVote", "claimCeremony", "claimContext", "claimSuccession", "clanBoard", "clanBoardPage", "clanByTag", "clanFor", "confirmLock", "confirmRebind", "decideRequest", "declareSolo", "declineInvite", "deleteLock", "deletePin", "demote", "directory", "disband", "dropPin", "editLock", "grantGuestPass", "invite", "kick", "leave", "linkStatus", "liveServers", "makeRoster", "mapState", "myInvites", "myRequests", "openVote", "playerBoards", "playerFeed", "playerProfile", "promote", "releaseSolo", "rename", "reportIncident", "requestJoin", "revealLock", "revokeGuestPass", "revokeInvite", "rotateLocks", "scoreboard", "searchGamertags", "seasons", "setRecruitingPost", "startLink", "suggestGamertags", "transfer", "unlink", "vaultFor", "viewerFor", "warLog", "withdrawRequest"]);
  });
});
