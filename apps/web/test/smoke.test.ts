...
describe("the web app reads nothing", () => {
  ...
  it("⚠️ @factions/roster exports exactly the allowlist the site is permitted", async () => {
    ...
    expect(Object.keys(roster).sort()).toEqual(["BOARD_KINDS", "BOARD_PAGE_SIZE", "DECLARE_SOLO_REASONS", "ISSUE_OUTCOME_KINDS", "SUGGEST_SCOPES", "VAULT_NAME_MAX", "VAULT_NOTE_MAX", "acceptInvite", "addLock", "alphas", "attention", "baseFor", "boardPage", "cancelLink", "castVote", "claimCeremony", "claimContext", "claimSuccession", "clanBoard", "clanBoardPage", "clanByTag", "clanFor", "confirmLock", "confirmRebind", "decideRequest", "declareSolo", "declineInvite", "deleteLock", "deletePin", "demote", "directory", "disband", "dropPin", "editLock", "grantGuestPass", "invite", "kick", "leave", "linkStatus", "mapState", "myInvites", "myRequests", "openVote", "playerBoards", "playerProfile", "promote", "releaseSolo", "rename", "requestJoin", "revealLock", "revokeGuestPass", "revokeInvite", "rotateLocks", "scoreboard", "searchGamertags", "seasons", "setRecruitingPost", "startLink", "suggestGamertags", "transfer", "unlink", "vaultFor", "viewerFor", "warLog", "withdrawRequest"]);
  });
});
