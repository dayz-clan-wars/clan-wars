/**
 * The one description every share preview, tab and home-screen entry
 * carries. Written once here so the root layout, the landing page and the
 * manifest cannot drift apart — the home redesign (2026-09-09) changed the
