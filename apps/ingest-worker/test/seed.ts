...
/**
 * A verbatim copy of `apps/bot/test/seed.ts`. Two files in two packages do
 * not earn a shared test package, so the duplication is deliberate; keep the
 * two in step by hand if the schema moves again.
 *
