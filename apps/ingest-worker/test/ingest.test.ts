...
describe("ingestFile", () => {
  ...
  it("a hit, a knockout and a bare death land with the evidence the verdict reads", async () => {
    ...
    expect(rows[2]!.payload).toEqual({ victimDayzId: ID, victimGamertag: "YrJustBad", cause: "died", entity: null, water: 598.786, energy: 0, bleedSources: 1, victimPos: { x: 10848.6, y: 174.9, z: 11077 } });
  });
