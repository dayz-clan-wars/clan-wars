...
export const RENDERERS: Record<ClanNoticeKind, Renderer> = {
  ...
  non_member_raise: (p, ctx) => `⚑ ${person(p.gamertag)} (not a member) raised your flag at your base${since(ctx)}`,
  ...
  solo_non_member_raise: (p, ctx) => `⚑ ${person(p.gamertag)} (not a member) raised your flag at your base${since(ctx)}`,
  ...
  intruder: (p, ctx) => `👁 ${person(p.gamertag)} (not a member) was seen ${p.distance} m from your base${since(ctx)}`,
  dismantle: (p, ctx) => `🔧 ${person(p.gamertag)} (not a member) dismantled ${p.part} at your base${since(ctx)}`,
  gate_built: (p, ctx) => `🔧 ${person(p.gamertag)} (not a member) built a gate at your base${since(ctx)}`,
  ...
  built: (p, ctx) => `🔧 ${person(p.gamertag)} (not a member) built ${p.part} at your base${since(ctx)}`,
  solo_intruder: (p, ctx) => `👁 ${person(p.gamertag)} (not a member) was seen ${p.distance} m from your base${since(ctx)}`,
  solo_dismantle: (p, ctx) => `🔧 ${person(p.gamertag)} (not a member) dismantled ${p.part} at your base${since(ctx)}`,
  solo_gate: (p, ctx) => `🔧 ${person(p.gamertag)} (not a member) built a gate at your base${since(ctx)}`,
  solo_built: (p, ctx) => `🔧 ${person(p.gamertag)} (not a member) built ${p.part} at your base${since(ctx)}`,
