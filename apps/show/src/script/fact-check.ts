...
- who killed whom, and how many times: the killer and the victim must match the data exactly, never reversed;
...
{"errors":[{"line":"<the script line, copied exactly>","problem":"<what is wrong, and what the data actually says>"}]}
